...
import { HasilComponent, ListComponent } from "../components";
...
export default class Home extends Component {
  ...
  componentDidMount() {
    axios
      .get(API_URL + "products?category.nama=" + this.state.categories_aktif)
      .then((res) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (menus.length !== 0) {
          ...
          axios
            .put(API_URL + "keranjangs/" + menus[0].id, keranjang)
            .then((res) => {
              swal({
                title: "Suskes",
        ...
        <Container fluid>
          <Row>
            <ListComponent
              ...
              categories_aktif={categories_aktif}
            />
            <Col>
              <h4>Daftar Menu</h4>
              <hr />
            ...
            <HasilComponent keranjangs={keranjangs} />
          </Row>
        </Container>
      </div>
    );
